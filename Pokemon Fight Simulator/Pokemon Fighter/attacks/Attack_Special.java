...
public enum Attack_Special implements Attacks {
	CHARGE_BEAM(Types.ELECTRIC, 50, 90, 10, "70% spAtk +1", "Charge Beam"),
	MOONBLAST(Types.FAIRY, 95, 100, 15, "10% lowers foe's spAtk by 1 stage", "Moonblast"),
	BOOMBURST(Types.NORMAL, 140, 100, 10, "", "Boomburst"),
	FLAMETHROWER(Types.FIRE, 90, 100, 15, "10% burn", "Flamethrower"),
	...
	THUNDERBOLT(Types.ELECTRIC, 90, 100, 15, "10% paralysis", "Thunderbolt"),
	THUNDER(Types.ELECTRIC, 110, 70, 10, "30% paralysis", "Thunder"),
	ICE_BEAM(Types.ICE, 90, 100, 10, "10% freeze", "Ice beam"),
	BLIZZARD(Types.ICE, 110, 70, 5, "10% freeze", "Blizzard"),
	PSYCHIC(Types.PSYCHIC, 90, 100, 10, "10% lowers foe's spDef by 1 stage", "Psychic"),
	SHADOW_BALL(Types.GHOST, 80, 100, 15, "20% lowers foe's spDef by 1 stage", "Shadow ball"),
	FOCUS_BLAST(Types.FIGHTING, 120, 70, 5, "10% lowers foe's spDef by 1 stage", "Focus Blast"),
	AURA_SPHERE(Types.FIGHTING, 80, 1000, 10, "", "Aura sphere"),
	EARTH_POWER(Types.GROUND, 90, 100, 10, "10% lowers foe's spDef by 1 stage", "Earth power"),
	BUG_BUZZ(Types.BUG, 90, 100, 10, "10% lowers foe's spDef by 1 stage", "Bug buzz"),
	DARK_PULSE(Types.DARK, 80, 100, 15, "20% flinch", "Dark pulse"),
	DRAGON_BREATH(Types.DRAGON, 60, 100, 20, "30% paralysis", "Dragon Breath"),
	LEAF_STORM(Types.GRASS, 130, 90, 5, "lowers user's spAtk by 2 stages", "Leaf storm"),
	HURRICANE(Types.FLYING, 110, 70, 10, "30% confusion", "Hurricane"),
		...
		if (attack != null) {
			...
			if (attack.getPP() > 0) {
				...
				int finalDamage = (int) Math
						.floor((((attacker.getLevel() * 0.4 + 2) * attacker.getSpAtk() * attack.getPower())
								/ (attacked.getSpDef() * 50) + 2) * CM);
